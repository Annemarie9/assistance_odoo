# File: /content/odoo_doc17.0/fr/content/applications/finance/accounting/get_started/cheat_sheet.md
    ...
    **Current assets and liabilities**
    ...
    :   -   The **current assets** account is a balance sheet line item
        ...
        -   **Current liabilities** are a company\'s short-term
            financial obligations due within one year. An example of a
            current liability is money owed to suppliers in the form of
            accounts payable.
...
Journal entries {#cheat_sheet/journals}
---------------
...
`Reconciliation <../../accounting/bank/reconciliation>`{.interpreted-text
role="doc"} is the process of linking journal items of a specific
