# File: /content/odoo_doc17.0/fr/content/applications/inventory_and_mrp/barcode/setup/software.md
...
functionality via
`Inventory --> Settings --> Barcode Scanner`{.interpreted-text
role="menuselection"}. Once you have ticked the feature, you can hit
save.
...
`Settings --> Configure Products Barcodes`{.interpreted-text
role="menuselection"}.
