# File: /content/odoo_doc17.0/fr/content/applications/finance/accounting/payments/trusted_accounts.md
...
`Send Money`{.interpreted-text role="guilabel"} toggle switch button.
...
:   Double-check the **email address domain**
    ([example\@domain.com]{.title-ref}). However, be wary that
    fraudsters can make their email addresses look genuine or even hack
    email addresses from your vendor\'s employees or even someone within
