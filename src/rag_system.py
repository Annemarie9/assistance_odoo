...
class RAGSYTEM:
    ...
    def __init__(self, openai_client: str, db_connection_str: str, data_path: str, markdown_path: str):
        ...
        with psycopg.connect(db_connection_str) as conn:
            with conn.cursor() as cur:
                ...
                # Nouvelle table pour les fichiers Markdown
                cur.execute("""
    ...
    # === Enregistrement Embedding Markdown ===
    ...
    # === Recherche sémantique générale (TXT) ===
    ...
    # === Recherche sémantique spécifique Markdown ===
    ...
    def generate_response(self, context: str, user_query: str):
        ...
        completion = self.openai_client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": f"Tu es un assistant de la documentation odoo et local. Réponds à la question suivante : {user_query}, en utilisant ces informations : {context}"
                }
            ]
        )
